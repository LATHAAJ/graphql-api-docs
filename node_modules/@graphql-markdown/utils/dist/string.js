...
exports.toString = exports.slugify = exports.kebabCase = exports.startCase = exports.capitalize = exports.firstUppercase = exports.escapeMDX = exports.toHTMLUnicode = exports.stringCaseBuilder = exports.prune = exports.replaceDiacritics = void 0;
/**
 ...
 */
const escapeMDX = (str) => {
    return `${String(str)}`.replace(/(?<!`)([{<_*>}])(?=(?:[^`]*`[^`]*`)*[^`]*$)/g, exports.toHTMLUnicode);
};
